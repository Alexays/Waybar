...
waybar::modules::Network::~Network()
{
  ...
  if (info_sock_ != nullptr) {
    ...
    nl_socket_drop_membership(info_sock_, RTMGRP_IPV4_ROUTE);
    nl_socket_drop_membership(info_sock_, RTMGRP_IPV6_IFADDR);
    nl_socket_drop_membership(info_sock_, RTMGRP_IPV6_ROUTE);
    nl_close(info_sock_);
...
void waybar::modules::Network::createInfoSocket()
{
  ...
  if (nl_socket_add_memberships(info_sock_, RTMGRP_LINK, RTMGRP_IPV4_IFADDR,
    RTMGRP_IPV4_ROUTE, RTMGRP_IPV6_IFADDR, RTMGRP_IPV6_ROUTE, 0) != 0) {
